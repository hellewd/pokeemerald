...
const u16 gMetatiles_dead[] = INCBIN_U16("data/tilesets/secondary/dead/metatiles.bin");
const u16 gMetatileAttributes_dead[] = INCBIN_U16("data/tilesets/secondary/dead/metatile_attributes.bin");
