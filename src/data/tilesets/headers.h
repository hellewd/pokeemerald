...
const struct Tileset gTileset_dead =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_dead,
    .palettes = gTilesetPalettes_dead,
    .metatiles = gMetatiles_dead,
    .metatileAttributes = gMetatileAttributes_dead,
    .callback = NULL,
};
